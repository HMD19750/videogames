                ...
                <ul>
                    ...
                    <li class="border-b border-gray-700">
                        <a href="
                            ...
                            @if (isset($game['game']['cover']))
                                <img src="{{ Str::replaceFirst('thumb', 'cover_small', $game['game']['cover']['url']) }}"
                                    alt="cover" class="w-10">
                            @else
                            <img src="https://via.placeholder.com/264x352/111111" alt="game cover" class="w-10">
                            @endif
