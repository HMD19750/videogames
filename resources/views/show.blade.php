            ...
            @foreach($game['screenshots'] as $screenshot)
                <div>
                    <a href="{{ Str::replaceFirst('thumb','screenshot_huge',$screenshot['url']) }}">
                        <image src="{{ Str::replaceFirst('thumb','screenshot_big',$screenshot['url']) }}" alt="screenshot"
    ...
    <div class="similar-games-container mt-8">
        ...
        @foreach($game['similar_games'] as $game)
            ...
            <div class="game mt-8">
                ...
                <a href="{{ route('games.show',$game['slug'])}}" class="block text-base font-semibold leading-thight hover:text-gray-400 mt-8">{{ $game['name'] }}</a>
