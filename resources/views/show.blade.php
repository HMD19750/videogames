...
<div class="container mx-auto px-4">
    <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
        ...
        <div class="lg:ml-12 mr-16 lg:mr-32">
            <h2 class="font-semi-bold text-4xl leading-tight mt-1">{{ $game['name'] }}</h2>
        ...
        <div class="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
            ...
            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                <a href="{{ $game['social']['website']['url'] }}" class="hoover:text-gray-400">
            ...
            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                <a href="{{ $game['social']['instagram']['url'] }}" class="hoover:text-gray-400">
            ...
            @if(isset($game['social']['twitter']))
                <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                    <a href="{{ $game['social']['twitter']['url'] }}" class="hoover:text-gray-400">
            ...
            @if(isset($game['social']['facebook']))
                <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                    <a href="{{ $game['social']['facebook']['url'] }}" class="hoover:text-gray-400">
...
<div class="similar-games-container mt-8">
    ...
    <div class="popular-games grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12  pb-16">
