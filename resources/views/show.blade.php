...
<div class="container mx-auto px-4">
    <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
        ...
        <div class="lg:ml-12 mr-16 lg:mr-32">
            <h2 class="font-semi-bold text-4xl leading-tight mt-1">Final Fantasy VII Remake</h2>
            ...
            <div class="flex flex-wrap items-center mt-8 ">
                ...
                <div class="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
                    <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                        <a href="#" class="hoover:text-gray-400">
                ...
                <div>
                    <p class="mt-12">Eu Lorem officia ullamco incididunt magna sit quis do. Consectetur exercitation non
                        ipsum occaecat
                        laboris exercitation voluptate deserunt. Aute nisi aliquip eiusmod proident esse sit labore ad.
                        Laboris commodo in reprehenderit dolor ipsum id sint amet esse duis anim aliquip.</p>
                </div>

                <div class="mt-12">
                    <button
                        class="flex bg-blue-500 text-white semi-bold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
    ...
    <div class="images-container border-b border-gray-800 pb-12 mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
            <div>
                <a href="#">
                    <image src="/screenshot1.jpg" alt="screenshot"
                        class="hover:opacity-75 transition ease-in-out duration-150"></image>
                </a>
            </div>
            <div>
                <a href="#">
                    <image src="/screenshot2.jpg" alt="screenshot"
                        class="hover:opacity-75 transition ease-in-out duration-150"></image>
                </a>
            </div>
            <div>
                <a href="#">
                    <image src="/screenshot3.jpg" alt="screenshot"
                        class="hover:opacity-75 transition ease-in-out duration-150"></image>
                </a>
            </div>
            <div>
                <a href="#">
                    <image src="/screenshot4.jpg" alt="screenshot"
                        class="hover:opacity-75 transition ease-in-out duration-150"></image>
                </a>
            </div>
            <div>
                <a href="#">
                    <image src="/screenshot5.jpg" alt="screenshot"
                        class="hover:opacity-75 transition ease-in-out duration-150"></image>
                </a>
            </div>
            <div>
                <a href="#">
                    <image src="/screenshot6.jpg" alt="screenshot"
                        class="hover:opacity-75 transition ease-in-out duration-150"></image>
                </a>
            </div>
        </div>
    ...
    <div class="similar-games-container mt-8">
        <h2 class="text-blue-500 uppercase tracking-wide font-semi-bold">Similar games</h2>

        <div
        class="popular-games grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12  pb-16">
        <!-- Game tegel -->
        <div class="game mt-8">
